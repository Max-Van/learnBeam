...
class ReadRecordsOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
        ...
        parser.add_value_provider_argument("--query", dest="query", default="SELECT * FROM max.heros;")
        parser.add_value_provider_argument("--user", dest="user", default="root")
        parser.add_value_provider_argument("--password", dest="password", default="wuming490511")
